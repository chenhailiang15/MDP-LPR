 ...
 * @version: 1.0
 */
public class Exp1ConvergenceGA {
...
//            Scanner scan = new Scanner(System.in);
            ...
            if (System.getProperty("os.name").equals("Windows 10")){
                ...
                out_file_path="/ai/hpc4chl/paper1/Exp11/";
            }
            ...
            long GA_seed=0;
            String ga_out_path;
            Parameters4Solver ga_parameters;
            ...
            File file_out=new File(out_file_path+"Exp1.ga-"+exp_flage+".txt");
                ...
                for (File dax_file:root_file.listFiles()){
                    ...
                    if (file_name.split("\\.")[4].equals("dax") && file_name.split("\\.")[2].equals(Integer.toString(i))){
                        ...
                        for(int j=0;j<repeat_time;j++){
                            ...
                            ga_out_path=out_file_path+"exp1-opt_traj.ga-"+file_name+"-"+exp_flage+"-"+j+".txt";

                            ga_parameters=new Parameters4Solver(jobs,service_info,cpu_weight,mem_weight,disk_weight,
                                    pop_num,iteration_num,cross_prob,mutation_prob,GA_seed,out_flage,ga_out_path);

                            long time1=System.currentTimeMillis();
                            SolverGAH ga1solver=new SolverGAH(ga_parameters);
